...
import { links } from "../pages/links-fr";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tooltip title="Code source du projet" arrow placement="right">
          <Link
            target="_blank"
            href={"https://github.com/MosMid/react-vscode-portfolio"}
            underline="none"
            color="inherit"
      ...
      >
        <Tooltip
          title={darkMode ? "Allume la lumiére!" : "Eteins la lumiére!"}
          placement="right"
          arrow
        >
          <Box
